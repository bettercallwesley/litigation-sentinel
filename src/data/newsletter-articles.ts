...
export const ARTICLES: NewsletterArticle[] = [
  {
    slug: "nc-hb315-signed-first-state-ban-enacted",
    section: "Litigation Strategy",
    tag: "Case Watch",
    title: "North Carolina Outlawed Litigation Funding. One Sentence, $50,000 a Violation, a Near-Unanimous Vote.",
    subtitle: "On June 22, 2026, North Carolina became the first state in the country to ban third-party litigation funding outright. One sentence, a $50,000-per-violation penalty, a 45-to-1 Senate vote, and a personal-jurisdiction hook written into the statute itself.",
    readTime: "4 min read",
    author: "Wesley Todd",
    date: "June 26, 2026",
    trending: true,
    content: [
      { type: "paragraph", text: "On June 22, 2026, at 3:26 in the afternoon, Gov. Josh Stein signed his name to a law no governor in America had ever signed. He approved [House Bill 315](https://www.ncleg.gov/BillLookUp/2025/h315) as Session Law 2026-14. One sentence inside it ends an entire industry within North Carolina's borders. \"It is unlawful for a person to engage in litigation investment in this State or to furnish litigation investment to a party or counsel of record in a civil proceeding in this State.\" That sentence is now Section 66-513 of the General Statutes. The number that gives it teeth is fifty thousand dollars." },
      { type: "paragraph", text: "North Carolina did not disclose. It did not cap. It [banned](https://news.bloomberglaw.com/business-and-practice/north-carolina-enacts-ban-on-third-party-litigation-investment). It is the first state in the country to outlaw third-party litigation funding outright. Every other state that has moved on funders reached for a lighter tool. Some have only regulated the terms of consumer advances. Other legislatures want the funder's name in the file. North Carolina took the whole table." },
      { type: "paragraph", text: "The law is short and it is hard. It adds a new Article 52 to Chapter 66. A funding contract that violates it is void. The [North Carolina Attorney General](https://ncdoj.gov) may sue to enjoin a violation, and a court may stack a civil penalty of up to fifty thousand dollars on each one. A party hurt by a banned deal may sue for treble the full amount the investor ever stood to take. The statute orders judges to read it liberally. There is no soft edge here." },
      { type: "paragraph", text: "The vote shows how alone the funders stood. The Senate passed it 45 to 1, and the House concurred 112 to 0. The primary sponsors were Representatives Pyrtle, Miller, Carson Smith, and Reives. Stein, a Democrat, signed a bill the Republican majority wrote. The funders lost both parties at once." },
      { type: "paragraph", text: "The carve-out map shows who the law is aimed at. A lawyer may still work on contingency. A firm may still advance its own costs. An insurer's duty to defend a party is safe. A nonprofit may still fund its own suit. A family member may still pay a relative's court fees. None of that is litigation investment under the act. What dies is the outside money that buys a slice of a stranger's verdict. The bet on someone else's lawsuit. That is the target, and the act says so by leaving everything else alone." },
      { type: "paragraph", text: "Now the fight moves to a courtroom, and the law was built for that fight. Section 66-514(d) is where it shows its hand. It declares that any person who furnished litigation investment to a party in North Carolina \"has purposefully availed itself of the privileges of conducting business in this State\" and is subject to suit here. The legislature wrote the personal-jurisdiction hook into the ban itself. A funder in London or New York that touched a single North Carolina case is now, by statute, haled into a North Carolina court. The drafters did not wait to be challenged. They set the trap and named the venue." },
      { type: "paragraph", text: "So the funders have to choose. They can stay out of the state and surrender it. Or they can sue to kill the law, and the theories are already visible. The first is the Contracts Clause. But the act reaches only contracts entered, renewed, or amended on or after the day it became law, which strips the easy claim that it tore up deals already signed. The second is the dormant Commerce Clause, the argument that North Carolina cannot wall off a national capital market at its border. The third is due process. Each one is a real case. None of them is a sure win. A funder with billions deployed has to decide whether to spend its own money proving a court wrong about its own business model." },
      { type: "paragraph", text: "The scoreboard is moving now, because North Carolina did not act in a vacuum. Disclosure bills sit in statehouse after statehouse. Federal proposals would force a funder's name onto the docket. North Carolina jumped the whole line and proved a legislature can go from disclosure to prohibition in a single session. The industry that spent a decade arguing it was harmless just lost a state, by 45 to 1 in the Senate and 112 to 0 in the House. Every other capitol watched it happen." },
      { type: "paragraph", text: "The carve-outs hold the line at family, nonprofits, and the duty to defend. The ban holds the line everywhere else. Section 1 reaches every civil proceeding filed on or after June 22 and every funding contract signed, renewed, or touched on or after that day. The clock started the moment Stein capped his pen. There is no grace period. There is no phase-in." },
      { type: "paragraph", text: "A governor signed one page. A whole market lost a state. Now they sue, or they stay out." },
    ],
    sources: [
      {
        claim: "North Carolina enacts HB 315 / Session Law 2026-14 banning third-party litigation investment; Gov. Josh Stein signed June 22, 2026; new Article 52 to Chapter 66; $50,000 per-violation civil penalty; Senate 45-1, House 112-0",
        locator: "North Carolina General Assembly, House Bill 315 (2025 session)",
        url: "https://www.ncleg.gov/BillLookUp/2025/h315",
      },
      {
        claim: "North Carolina is the first state to enact an outright ban on third-party litigation investment",
        locator: "Bloomberg Law, 'North Carolina Enacts Ban on Third-Party Litigation Investment'",
        url: "https://news.bloomberglaw.com/business-and-practice/north-carolina-enacts-ban-on-third-party-litigation-investment",
      },
    ],
  },
  {
    slug: "ny-marine-case-cash-sue-the-funder",
    section: "Litigation Strategy",
    tag: "Case Watch",
    title: "A Carrier Sued the Funder, Not the Firm, Over a Frozen $750,000 Deal",
    subtitle: "New York Marine walked into the Southern District of New York and sued Case Cash Funding and a suspended-attorney principal, alleging a $76,500 advance became a $1.4 million lien that froze a settlement both sides called fair. The first test of 'sue the funder' as a carrier weapon.",
    readTime: "4 min read",
    author: "Wesley Todd",
    date: "June 26, 2026",
    trending: true,
    content: [
      { type: "paragraph", text: "On June 12, 2026, a carrier did something carriers almost never do. It walked into a Manhattan federal courthouse and [sued the money behind the lawsuit](https://www.insurancebusinessmag.com/us/news/risk-compliance-legal/new-york-marine-sues-case-cash-alleges-funder-targeted-insurers-578953.aspx), not the lawyer who filed it. New York Marine & General Insurance named Case Cash Funding and its principal, Gregory Elefterakis, as defendants. The theory is blunt. The funder, the carrier says, did not bankroll a case. It seized one." },
      { type: "paragraph", text: "The numbers tell the arc. Case Cash advanced $76,500. The claimant's own side then reached a figure everyone could live with. Counsel wrote that \"the neutrals agreed that a settlement in the amount of $750,000.00 was fair and reasonable.\" That deal should have closed. According to the complaint, it did not. The funder refused. Then it asserted a lien of $1,419,364.44 against the proceeds. A $76,500 advance had become a seven-figure claim, and a fair settlement sat frozen behind it." },
      { type: "paragraph", text: "Here is the maneuver at the center of the file. Funding contracts are written to look hands-off. They have to be. A loan that lets the lender steer the case starts to look like champerty, or like an unlicensed loan dressed up as an investment. So the paper says the right things. The Case Cash agreement warranted that the funder \"will have no influence, power or control over any matter relating to the Case, including any decision to settle.\" Read it cold and the funder is a passive buyer of an interest in proceeds. The agreement said as much, reciting that the deal \"represents a purchase of an interest in litigation proceeds resulting from a legal claim rather than a loan.\" The complaint reads it the other way. It calls that no-control clause \"window dressing.\" New York Marine says the conduct told the real story. A funder that blocked a settlement it had promised in writing it could not touch." },
      { type: "paragraph", text: "The principal sharpens the picture. Gregory Elefterakis is, in the complaint's own words, \"a suspended attorney who has not been reinstated.\" A lawyer the bar has sidelined now sits across a settlement table, the carrier says, holding the exact control his own contract disclaimed. New York keeps a [public roll of who is and is not in good standing](https://iapps.courts.state.ny.us/attorneyservices/search), so a suspension is not a secret. The carrier put that fact in a paragraph and built a fraud theory on top of it." },
      { type: "paragraph", text: "Then the complaint widens the lens, and this is where it stops being one stuck case. New York Marine points to a securitization. A pool called PEAR 2022-1 bundled $84,619,110.66 across 16,807 advances. That is the business model in one line. Thousands of small advances, packaged and sold, each one a lien waiting to attach to a settlement a carrier funds. The carrier's claim is that the model only works if the funder can squeeze the exit, and that the squeeze is the whole point. Sue the funder, the complaint argues, because the funder is the party setting the price of peace." },
      { type: "paragraph", text: "Strip away the securities math and the fight is old and human. Two sides agreed on $750,000. A third party who put in $76,500 said no, and pinned $1.4 million to the file. A settlement both sides called fair and reasonable did not happen, because the smallest stake at the table refused to leave it. That is the drama insurers have watched fund the other side for a decade. This time the carrier flipped the table and asked a federal judge to name the control for what it is." },
      { type: "paragraph", text: "The case now sits in the [Southern District of New York](https://www.nysd.uscourts.gov/), where the funder will have to answer for the gap between what the contract promised and what the carrier says it did. The first real test is the responsive pleading. Case Cash must move to dismiss or file an answer, and either way it has to confront its own warranty: no influence, no power, no control. A judge will decide whether \"window dressing\" is argument or fact. That motion-to-dismiss ruling sets the early line on whether \"sue the funder\" survives as a carrier weapon or dies at the threshold." },
      { type: "paragraph", text: "For years, funders have sat behind the curtain and set the terms. One carrier just pulled the curtain back. Now it has to talk." },
    ],
    sources: [
      {
        claim: "New York Marine & General Insurance sues Case Cash Funding and principal Gregory Elefterakis (a suspended attorney); $76,500 advance, $1,419,364.44 lien, frozen $750,000 settlement; PEAR 2022-1 securitization of $84,619,110.66 across 16,807 advances; filed June 12, 2026, SDNY",
        locator: "Insurance Business America, 'New York Marine sues Case Cash, alleges funder targeted insurers'",
        url: "https://www.insurancebusinessmag.com/us/news/risk-compliance-legal/new-york-marine-sues-case-cash-alleges-funder-targeted-insurers-578953.aspx",
      },
    ],
  },
  {
    slug: "maine-23m-ticking-time-bomb-giordano",
    section: "Litigation Strategy",
    tag: "Case Watch",
    title: "Maine jury hands a paralyzed man $23.1M, finds his hospital failed to act on its own CT",
    subtitle: "An Aroostook County jury returned the largest non-death medical malpractice verdict in Maine history after finding Northern Light A.R. Gould Hospital missed a critical CT finding and did not follow its own reporting policy. The rule the hospital wrote became the plaintiff's best exhibit.",
    readTime: "4 min read",
    author: "Wesley Todd",
    date: "June 26, 2026",
    trending: false,
    content: [
      { type: "paragraph", text: "On June 18, 2026, twelve jurors in Aroostook County, Maine, found that Robert Giordano had carried a bomb in his spine for six weeks while the people paid to watch for it failed to catch it. They set the number at $23.1 million, the largest non-death medical malpractice verdict in the state's history. The bomb was the trial's own frame. According to Berman & Simmons, the plaintiff's firm, the jury heard the case described this way: \"As the patient developed progressive neurologic deficits over the next six weeks, people were unaware that he had this ticking time bomb in his spine,\" [the firm says in its release announcing the verdict](https://www.prnewswire.com/news-releases/berman--simmons-attorneys-secure-record-23-1-million-medical-malpractice-verdict-in-maine-302806810.html). \"It then detonated on Jan. 30, with him becoming fully and permanently paralyzed.\"" },
      { type: "paragraph", text: "Giordano is 40. He lives in Madawaska, a mill town at the top of the state, hard on the Canadian line. He fell. He went to the emergency room at Northern Light A.R. Gould Hospital. A CT scan was taken. The scan showed a large bony mass pressing into his spinal canal. The plaintiff's case was that the radiologist read the study and never flagged the finding." },
      { type: "paragraph", text: "That is the fact the defense could not bury. The threat was on the film. The hospital's own rules said a finding like that gets reported, fast, to someone who can act on it. The jury found those rules were not followed." },
      { type: "paragraph", text: "So the threat sat there and grew. Giordano got worse by degrees. His legs began to fail him. On January 29, the plaintiff's case held, a primary care provider waved the symptoms off as a man chasing pain medicine, and an orthopedic specialist who saw him the same stretch did not see an emergency. The next morning the cord gave out. He has no function from the chest down. No bladder. No bowel. No path back." },
      { type: "paragraph", text: "Travis M. Brennan of Berman & Simmons tried the case for Giordano. He did not lead with the missed read alone. He led with the policy. \"Northern Light first missed a dangerous finding on Robert's imaging study and failed to follow its own internal policies on reporting this critical finding,\" Brennan said. That is the line that turns a defensible miss into a record award. A radiologist can miss. Juries forgive a hard read. They do not forgive an institution that wrote a safety rule and then, on the jury's finding, did not follow it." },
      { type: "paragraph", text: "That distinction is the whole story for anyone who reserves a hospital file. A single missed scan is a coverage question. A documented critical-finding policy the jury found the hospital did not run is a different animal. It is notice. The loss was already building before the claim existed on paper, before the suit, before the day in [Aroostook County Superior Court](https://www.courts.maine.gov/courts/superior/index.html) when the verdict came in. The exposure was set the hour the scan was read." },
      { type: "paragraph", text: "The number lands where the story does. $23.1 million is a Maine record for a living plaintiff. Northern Light Health is one of the largest health systems in the state, and the loss runs through its professional liability program. This is not the biggest verdict in the country this year. It is the cleanest one in the window. A named institution. A named plaintiff. A named scan. A written rule the jury found the institution did not keep. Every piece of it is on the record, and none of it depends on a sympathetic jury reading a hard case kindly." },
      { type: "paragraph", text: "The pattern repeats because institutions keep building it. A health system writes the rule that would have caught the harm. The system does not run the rule. The rule it wrote becomes the plaintiff's best exhibit. Northern Light now sits in the same file as every defendant undone by its own paperwork. The [Maine Board of Licensure in Medicine](https://www.maine.gov/md/) governs the clinicians who touched the case. The policy that failed governed the building they worked in, and the building is what the jury charged." },
      { type: "paragraph", text: "The verdict is not the last word. Post-trial motions and the appeal window opened the day the jury read the figure, June 18. Northern Light can move to cut the award or move to try the case again. None of it moves the facts that built the loss. The mass was on the scan. The rule was on the books. The jury found the hospital read one and broke the other, and a man who walked into its emergency room will not walk out of the chair he leaves in. The film does not lie. The rule does not bend. The man does not stand back up." },
    ],
    sources: [
      {
        claim: "Aroostook County, Maine jury awards Robert Giordano $23.1M June 18, 2026, largest non-death med-mal verdict in state history; missed CT finding and failure to follow critical-finding reporting policy; Berman & Simmons, Travis M. Brennan; defendant Northern Light A.R. Gould Hospital",
        locator: "PR Newswire, 'Berman & Simmons Attorneys Secure Record $23.1 Million Medical Malpractice Verdict in Maine'",
        url: "https://www.prnewswire.com/news-releases/berman--simmons-attorneys-secure-record-23-1-million-medical-malpractice-verdict-in-maine-302806810.html",
      },
    ],
  },
  {
    slug: "jw-aluminum-ace-80m-bi-sublimit-fourth-circuit",
    section: "Litigation Strategy",
    tag: "Case Watch",
    title: "How a Court and Jury Restored the $80 Million Sub-Limit One Endorsement Cut to Ten",
    subtitle: "A coffee-cup splash of molten aluminum started a fire that ran past $100 million. ACE American read one endorsement to cap the molten-metal exposure at $10 million. A jury awarded JW Aluminum $112.3 million, the full $80 million sub-limit included. Now the insurers have appealed to the Fourth Circuit.",
    readTime: "5 min read",
    author: "Wesley Todd",
    date: "June 26, 2026",
    trending: false,
    content: [
      { type: "paragraph", text: "In 2020, on a production line in Goose Creek, South Carolina, a splash of molten aluminum no bigger than a coffee cup hit the floor and started a fire that nearly took the whole plant. No worker was hurt. No first responder was hurt. The damage ran past a hundred million dollars anyway, tens of millions in wrecked equipment and hundreds of millions in lost profits, all from a splash a single hand could have covered." },
      { type: "paragraph", text: "JW Aluminum Company had bought coverage for exactly this. An all-risk property program with a business-interruption layer, the kind a sophisticated insured carries so one bad shift never turns into an existential one. When the loss landed, the company turned to its insurers, led by ACE American Insurance Company, the Chubb unit on the paper, and asked them to pay what the policy promised. The story is laid out in [The Texas Lawbook](https://texaslawbook.net/reid-collins-secures-112-3m-verdict-for-aluminum-company-in-insurance-case/)." },
      { type: "paragraph", text: "The insurers read the policy back differently." },
      { type: "paragraph", text: "They pointed to one endorsement. The language reached coverage for \"direct physical loss or harm caused by heat from molten material,\" and on the carrier reading, that endorsement carved the molten-metal exposure down from $250 million to a $10 million sub-limit. So coverage the company believed ran into nine figures for a molten-aluminum event was, on the insurer math, capped near ten. One paragraph did the cutting. A fire that started with a coffee-cup splash met a sentence built to shrink it." },
      { type: "paragraph", text: "That is the move worth naming. Not the fire. The endorsement. A loss this size lives or dies on which numbers a court lets the policy mean, and the insurers were asking the court and the jury to read the big number out and the small number in. The plant burned once. The coverage was being asked to burn twice." },
      { type: "paragraph", text: "JW Aluminum did not take the haircut. It sued. Reid Collins and Tsai, led by William T. Reid IV, took the policy-language fight into the [U.S. District Court for the District of South Carolina](https://www.propertyinsurancecoveragelaw.com/blog/large-business-interruption-verdict-results-in-post-trial-fights/), case number 2:21-cv-01034. The carriers had already won summary judgment once. The Fourth Circuit reversed it and sent the dispute back for trial, which is the only reason a jury ever saw the endorsement at all." },
      { type: "paragraph", text: "At trial the question was plain. Does one endorsement get to erase eight figures of business-interruption recovery, or does the insured collect the sub-limit it paid for? The jury sat with the policy. It sat with the splash. It sat with the months of stopped production that followed. Then it answered." },
      { type: "paragraph", text: "The carriers' cap argument did not survive the litigation. A court ruled the molten-material endorsement did not cap the claimed loss, and on November 19, 2025, the jury returned a unanimous verdict for JW Aluminum of $112.3 million. The breakdown is the whole point. $32.3 million for repair and replacement. And the full $80 million business-interruption sub-limit, awarded in full, the exact number the insurers had tried to read down to ten. The endorsement that was supposed to hold the loss near $10 million did not survive the court's reading of the policy or the jury's award. And the verdict figure sits before roughly five years of pre-judgment interest, which only widens the gap between what the carriers offered and what the policy cost them." },
      { type: "paragraph", text: "William Reid, whose younger lawyers tried much of the case, told The Texas Lawbook the moment was \"pretty dramatic.\" For an insured staring at a sub-limit fight, the drama was the math. Eighty million dollars turned on a reading the carriers lost." },
      { type: "paragraph", text: "The endorsement that nearly cut JW Aluminum's recovery by seventy million dollars had been sitting in the program the whole time, quiet, until a covered event made it load-bearing. Most coverage towers carry one like it. A sub-limit endorsement reads like boilerplate on the day a company binds it and reads like a trap on the day that company files. JW Aluminum found its trap only after the fire, in a courtroom, in front of a jury. The cheaper version of that fight is the one fought over the policy language before anything burns at all." },
      { type: "paragraph", text: "The fight is not over. On May 19, 2026, the insurers docketed their appeal to the U.S. Court of Appeals for the Fourth Circuit, [No. 26-1619](https://dockets.justia.com/docket/circuit-courts/ca4/26-1619). The same court that once revived this case by reversing summary judgment now holds the question of whether the full $80 million sub-limit can stand over a buried endorsement built to shrink it. The briefing schedule is not yet public. The docket is open and live as of today." },
      { type: "paragraph", text: "So the splash is settled and the number is not. The litigation said the endorsement does not cap the loss at ten, the court in its reading of the policy and the jury in its full-sub-limit award. Now a higher court gets to say if that no still holds. The plant stands. The fight does not." },
    ],
    sources: [
      {
        claim: "JW Aluminum v. ACE American (Chubb), case 2:21-cv-01034 D.S.C.; molten-material endorsement quoted 'direct physical loss or harm caused by heat from molten material'; jury returned $112.3M Nov 19, 2025 ($32.3M repair, full $80M BI sub-limit); William T. Reid IV, Reid Collins & Tsai; insurers' appeal docketed May 19, 2026 to Fourth Circuit No. 26-1619",
        locator: "The Texas Lawbook, 'Reid Collins Secures $112.3M Verdict for Aluminum Company in Insurance Case'",
        url: "https://texaslawbook.net/reid-collins-secures-112-3m-verdict-for-aluminum-company-in-insurance-case/",
      },
    ],
  },
  {
