...
export const ARTICLES: NewsletterArticle[] = [
  ...
  },
  {
    ...
    section: "Litigation Strategy",
    tag: "The Maturity Curve",
    title: "Everest Strengthened Reserves $1.7 Billion. The Cases Were Visible the Whole Time.",
    subtitle:
      "A $1.7 billion miss is not a pricing failure. It is a seeing failure. There is a five-stage path from a claims system that tracks your files to a layer that shows you exposure hardening while you can still act on it. Here is where you are on it, and what breaks at each stage you skip.",
    readTime: "11 min read",
    author: "Wes Todd",
    date: "February 3, 2026",
    readers: 2218,
    content: [
      { type: "paragraph", text: "On January 27, 2025, Everest Group disclosed to the SEC a reserve move north of a billion dollars. [The 8-K](https://www.sec.gov/Archives/edgar/data/1095073/000109507325000008/everest1-27x25pressrelease.htm) booked $1.5 billion of unfavorable development on prior-year loss reserves, and with current-year strengthening, \"total strengthening is $1.7 billion for the full-year and fourth quarter 2024.\" The cause Everest named was not a bad quarter in the markets. The filing attributes the strengthening to \"a combination of social inflation and portfolio concentrations in certain U.S. casualty lines.\"" },
      { type: "paragraph", text: "Read the named cause again. Social inflation. That is the industry's phrase for cases resolving higher than reserves assumed, because juries grow angrier and plaintiff firms grow sharper while a file ages. A disclosure like this is consistent with a reserve process that did not fully reflect worsening casualty severity until the periodic reserve review forced the number to move. Whatever Everest's internal tooling, the public shape of the event is plain. The strengthening was prior-year, which means the exposure had been building on cases already on the book before the reserve caught up to it." },
      { type: "paragraph", text: "Note what that shape implies for any casualty book, not just Everest's. The cases are not hidden. A carrier carrying U.S. casualty lines has claim numbers, venues, assigned counsel, and reserve figures for every matter. The thing that is hard to hold in view is not the existence of the cases. It is the rate at which exposure on them is changing relative to the numbers being carried. The information sits in the file. A real-time read on how fast it is moving usually does not." },
      { type: "pullquote", text: "A reserve move that size is rarely a pricing failure. It is a seeing failure." },
      { type: "paragraph", text: "This is an industry pattern, not one company's stumble. Two quarters earlier, [Selective Insurance disclosed](https://www.sec.gov/Archives/edgar/data/230557/000023055724000018/q22024pressreleaseexh991.htm) $176 million of net unfavorable prior-year casualty development in a single quarter, enough to push its combined ratio to 116.1%. Its CEO told the SEC the development reflected \"higher severity that we attribute to social inflation,\" and that \"our reserving action is predicated on our in-depth quarterly reserve review.\" Sit with that last phrase, in the company's own words. The read on whether exposure is hardening arrives in a quarterly review. The cases harden every day in between." },
      { type: "heading", text: "Spend Is Tracked. Outcomes Are Not." },
      { type: "paragraph", text: "The reflex when a number like that hits is to blame the system. The claims platform, the matter-management tool, the e-billing stack. Leadership decides the system is the problem and goes shopping for a replacement. That reflex is almost always wrong, and the data on why is blunt." },
      { type: "paragraph", text: "A November 2025 survey of 284 chief legal officers and legal-operations leaders by the [Association of Corporate Counsel and Everlaw](https://www.everlaw.com/press/release/gen-ai-accelerates-legal-work-acc-everlaw-survey/) found that 83 percent of legal teams track outside counsel spend, while only 16 percent track litigation outcomes relative to cost. Twelve percent track outside counsel performance. The [Thomson Reuters 2025 Legal Department Operations Index](https://www.thomsonreuters.com/en-us/posts/corporates/2025-ldo-index-legal-success-metrics/) found the same shape from the other side: fewer than one in five departments measure the quality of legal outcomes. Almost everyone counts what they spend. Almost no one measures what the spend bought." },
      { type: "paragraph", text: "That is the gap a replacement system does not close. A new platform with the same blind data is just blindness in a newer box. The capability the board actually wants is not a place to store files. It is the ability to see a case hardening before the reserve has to catch up to it. That capability is not a system you buy. It is a layer you build on the data you already keep, and it arrives in stages." },
      { type: "heading", text: "The Litigation Intelligence Maturity Curve" },
      { type: "paragraph", text: "There are five stages between a claims system that holds your files and a layer that shows you severity forming while you can still act on it. Each stage has a question that tells you where you sit today, a specific change in data and workflow it requires, and a failure that arrives if you skip it. A disclosure like Everest's is the kind of casualty reserve movement this curve is built to evaluate. The point is not where Everest sat on it. The point is where you sit." },
      { type: "heading", text: "Stage 1. Inventory" },
      { type: "paragraph", text: "Where you are today: you can answer how many matters are open, who is assigned, and what you have spent. You cannot answer how any of them are trending. This is the floor, and almost every department clears it. A matter system logs parties, jurisdiction, practice area, assigned firm. Invoices flow in. A report shows spend by firm and by matter type. The board sees total open matters and total spend year to date." },
      { type: "paragraph", text: "What this stage requires: a single system of record that every matter actually lands in. Not three spreadsheets and a shared drive. One place where the file exists." },
      { type: "paragraph", text: "What breaks if you skip it: you cannot build anything above a count. If matters live in four systems that do not agree on what a case is, every number above this stage inherits the disagreement. Most departments are here and mistake it for finished. Inventory is not visibility. It is the loading dock." },
      { type: "heading", text: "Stage 2. Data Readiness" },
      { type: "paragraph", text: "Where you are today: the facts that decide a case exist, but they are scattered. Incident and reserve data sit in the claims system. Venue, judge, opposing counsel, liability assessment, and negotiation history sit in counsel reports and internal notes. Legal spend sits in e-billing. The demand letters, mediation briefs, and expert reports sit in email and document portals. Four categories of data, four different homes, none of them talking." },
      { type: "paragraph", text: "What this stage requires: mapping each of those four categories to a source and a transfer method. Structured fields move by CSV or by direct integration with the claims or billing system. The signal buried in documents, the demand history and the severity language a lawyer writes into a status report, gets extracted rather than retyped. This is unglamorous work. It is also the work, because everything intelligent above it reads from here." },
      { type: "paragraph", text: "What breaks if you skip it: you get a dashboard that looks like intelligence and is not. Venue and opposing-counsel fields sit empty, so no performance score can compute. The system can tell you a case is expensive. It cannot tell you whether expensive is justified by the venue and the opponent, because the fields that would say so were never mapped. This is where the rip-and-replace projects die. The vendor demos a finished dashboard. Nobody asks where the data behind it comes from." },
      { type: "heading", text: "Stage 3. Activation" },
      { type: "paragraph", text: "Where you are today: the data is mapped and loading, and the portfolio is becoming visible in real time instead of quarterly. Open matters surface against budget thresholds and aging rules as they cross them, not three months later in a narrative. Closed matters start building a precedent record of how cases in your book actually resolved, by resolution type and by stage." },
      { type: "paragraph", text: "What this stage requires: exception rules and intervention triggers configured against the loaded data. A case over budget flags itself. A matter aging past a threshold without a negotiation flags itself. The workflow change is the hard part. Someone has to own the flags and act on them, which means the weekly portfolio review stops being a spend recap and starts being a triage." },
      { type: "paragraph", text: "What breaks if you skip it: you stay on the quarterly cadence that the Selective filing describes in its own words, a reserve action predicated on a quarterly review. Severity formation, the stretch where a case moves from its first evaluation to the figure it actually resolves at, happens in the middle of the lifecycle. Not at filing, not at trial. In the months between, when a quarterly review is collecting narratives instead of measuring change. Skip activation and you are still settling a number the case set months before you saw it move." },
      { type: "heading", text: "Stage 4. Calibration" },
      { type: "paragraph", text: "Where you are today: outcomes are scored against difficulty, not just counted. You can say whether the firm on your highest-exposure matter wins this kind of case, in this venue, against this opponent, more often than the firm you passed over. Performance is read net of how hard the case was, so a firm that takes the brutal venues is not punished for losing more than a firm that cherry-picks." },
      { type: "paragraph", text: "What this stage requires: enough closed-case data, with liability, damages, venue, and opposing counsel attached, that scoring calibrates instead of guessing. It requires both halves of the organization to read it. The claims and legal-ops teams have to trust the scores enough to route work by them. The executive sponsor has to be fluent enough to defend a counsel decision to the board with a number instead of a relationship." },
      { type: "paragraph", text: "What breaks if you skip it: you assign your most dangerous case to a firm with a great relationship and a quiet record of losing exactly this matchup, and you never learn it was a pattern. You negotiate counsel rates on spend, the one number you have, and leave outcome quality, the number that actually moves exposure, entirely out of the conversation." },
      { type: "heading", text: "Stage 5. Command" },
      { type: "paragraph", text: "Where you are today: you see severity hardening on a live matter and act before the reserve has to. The trajectory of a case shows up before mediation, not in the call afterward about the mediator's proposal. The board's questions about exposure get answered with the portfolio's current state, not last quarter's snapshot." },
      { type: "paragraph", text: "What this stage requires: the prior four stages, running and trusted, plus the discipline to let the signal drive intervention. The data layer surfaces the hardening case. A human still decides what to do about it. The change is that the decision now happens while it is still a decision and not a write-off." },
      { type: "paragraph", text: "What breaks if you skip it: a casualty book stays exposed to large prior-year reserve movements, the category of event a $1.7 billion strengthening belongs to, surfacing only when outcomes force the number. The scale of these moves is not random. The U.S. Chamber Institute for Legal Reform [studied 1,288 nuclear verdicts](https://instituteforlegalreform.com/wp-content/uploads/2024/05/ILR-May-2024-Nuclear-Verdicts-Study.pdf) and found a median of $21 million and an average of $89 million. Swiss Re [measured social inflation](https://www.swissre.com/dam/jcr:6bc7d3b7-0f42-4209-a01a-e22787b98685/sri-sigma4-2024-litigation-costs-claims-inflation-final.pdf) at roughly 7 percent in 2023, a twenty-year high, with 89 verdicts over $10 million and 27 over $100 million in a single year. A book of cases that hardens at that rate will outrun any model that only checks once a quarter." },
      { type: "heading", text: "Run the Diagnostic on Yourself" },
      { type: "paragraph", text: "Before you read further, place your own organization. Take your single highest-exposure open matter, the one a board member would name. Can you say today, without an email to outside counsel, whether the lawyer on it wins this kind of case, in this venue, against this opponent, more often than the lawyer you did not assign? Not how much you have spent. The odds." },
      { type: "paragraph", text: "If you cannot answer, you are at Stage 1 or 2, and the thing you are missing was never going to arrive in a new claims system. Now ask the harder one. If that matter's probable outcome doubled over the last six months, would you know now, or would you learn it in the mediation call? If the honest answer is the call, you are below Stage 5, and you are carrying the kind of exposure that surfaces only when the reserve has to catch up to it." },
      { type: "paragraph", text: "Most departments score themselves at Stage 1 or 2 and assume they are higher, because Inventory feels like control. It is not. It is a list. The jump that changes outcomes is from a system that holds your files to a layer that reads them and tells you which case is about to cost more than the reserve says." },
      { type: "callout", text: "If you want to see the layer before you build it, walk the [Litigation Intelligence Command Center](https://www.litigationsentinel.com/command-center). It maps the five stages against your own portfolio, shows what each dashboard looks like as your data loads, and ends with where you sit on the curve. No login, no rip-out, no system to replace. The data it reads is the data you already keep." },
      { type: "paragraph", text: "Everest had the cases on its book and still disclosed a $1.7 billion strengthening. On a casualty book, the information is rarely the problem. The seeing is. That is what the layer is for. The cases are already in your files. The only question is whether you see them move in time to do anything about it." },
    ],
    sources: [
      {
        claim:
          "Everest Group disclosed $1.7B total reserve strengthening for full-year/Q4 2024 ($1.5B unfavorable prior-year development), 'driven by a combination of social inflation and portfolio concentrations in certain U.S. casualty lines'; verbatim 'total strengthening is $1.7 billion for the full-year and fourth quarter 2024.'",
        locator: "Everest Group, Ltd. Form 8-K (press release exhibit), filed January 27, 2025",
        url: "https://www.sec.gov/Archives/edgar/data/1095073/000109507325000008/everest1-27x25pressrelease.htm",
      },
      {
        claim:
          "Selective Insurance Group took $176M net unfavorable prior-year casualty reserve development in Q2 2024 (including $166M general liability from AY2020-2023), pushing the combined ratio to 116.1%; CEO verbatim: development 'reflecting higher severity that we attribute to social inflation' and 'our reserving action is predicated on our in-depth quarterly reserve review.'",
        locator: "Selective Insurance Group, Inc. Form 8-K (Q2 2024 earnings, Exhibit 99.1), filed July 18, 2024",
        url: "https://www.sec.gov/Archives/edgar/data/230557/000023055724000018/q22024pressreleaseexh991.htm",
      },
      {
        claim:
          "83% of corporate legal teams track outside counsel spend while only 16% track litigation outcomes relative to cost, and 12% track outside counsel performance (survey of 284 CLOs/GCs/legal-ops leaders)",
        locator: "Association of Corporate Counsel & Everlaw, 'The Role of Generative AI in Proving Corporate Law Department Value,' November 17, 2025",
        url: "https://www.everlaw.com/press/release/gen-ai-accelerates-legal-work-acc-everlaw-survey/",
      },
      {
        claim:
          "Across 1,288 nuclear verdicts (jury awards of $10M or more), the median was $21 million and the mean was $89 million",
        locator: "U.S. Chamber of Commerce Institute for Legal Reform, 'Nuclear Verdicts: An Update on Trends, Causes, and Solutions,' May 2024",
        url: "https://instituteforlegalreform.com/wp-content/uploads/2024/05/ILR-May-2024-Nuclear-Verdicts-Study.pdf",
      },
      {
        claim:
          "U.S. social inflation reached roughly 7% in 2023, a 20-year high; in 2023, 89 lawsuits produced verdicts over $10M (a 15-year high) and 27 cases exceeded $100M",
        locator: "Swiss Re Institute, sigma No 4/2024, 'Litigation costs drive claims inflation: indexing liability,' September 2024",
        url: "https://www.swissre.com/dam/jcr:6bc7d3b7-0f42-4209-a01a-e22787b98685/sri-sigma4-2024-litigation-costs-claims-inflation-final.pdf",
      },
      {
        claim:
      ...
      {
        claim:
          "Kemper Corporation abandoned and wrote off a core-system replacement: $54.6M (2014, policy administration system) and $11.1M (2015, billing system); verbatim 'The Company continues to believe that it is necessary to replace these systems to remain competitive.'",
  ...
  {
    slug: "nc-hb315-funding-ban",
    section: "Litigation Strategy",
    tag: "Litigation Funding",
    title: "North Carolina Is One Signature From Banning Litigation Funding Outright",
    subtitle:
    ...
    readers: 1672,
    content: [
      { type: "paragraph", text: "Governor Josh Stein has a bill on his desk that no governor in the country has ever signed. It landed there June 12. As of this writing, six days later, he has not touched it. The pen is the only thing standing between North Carolina and the first outright ban on third-party litigation funding in the United States." },
      { type: "paragraph", text: "Most states that have moved on funding moved on disclosure. Tell the court who is bankrolling the plaintiff. Cap the funder's cut. Force a plain-language contract. North Carolina's [House Bill 315](https://www.ncleg.gov/BillLookUp/2025/HB315) does none of those half-measures. It bars the arrangement itself. No person or entity may fund a claimant or a defendant in exchange for a contingent stake in the outcome of a case. The funding model that built a multibillion-dollar global industry would simply become illegal inside the state line." },
      { type: "paragraph", text: "The vote was not close. The North Carolina House passed the measure 112 to 0 in March 2025. The Senate sent it back on June 9, 2026, by a margin of [45 to 1](https://www.ncleg.gov/BillLookUp/2025/HB315). One senator out of forty-six dissented. The bill was ratified June 11 and presented to the Governor the next morning under the legislature's own short title, \"Prohibit Litigation Invest/Amend WC Benefits.\" A near-unanimous, bipartisan wall behind a law that would erase an entire financing class is the kind of vote count that does not happen by accident." },
      { type: "paragraph", text: "The carve-outs tell you who the legislature was aiming at. Nonprofits are spared. Legal-aid groups are spared. Insurers defending their own policyholders are spared. A family member who fronts a relative's case is spared. What is left in the crosshairs is the commercial funder, the institution that writes an eight-figure check against a docket and waits for the verdict. The narrowness of the exceptions is the point. This is not a transparency rule dressed up as reform. It is a kill shot at a business model." },
      { type: "paragraph", text: "That puts a name in the line of fire. [Burford Capital](https://news.bloomberglaw.com/business-and-practice/litigation-finance-ban-legislation-advances-in-north-carolina), the largest publicly traded litigation funder in the world, surfaced in Bloomberg Law's coverage as one of the firms assessing its North Carolina exposure and the enforceability of the ban. Litigation Capital Management was named alongside it. For a funder, a single-state ban is more than lost deal flow. It is a precedent risk. North Carolina passed this 45 to 1. If a signature turns that tally into law, every other state legislature gets a template and a proof of concept, and the industry's entire regulatory argument shifts from \"how should funding be disclosed\" to \"should funding exist at all.\"" },
      { type: "paragraph", text: "The contrast with the rest of the map sharpens the drama. The same fortnight North Carolina moved to ban, New York's [Consumer Litigation Funding Act](https://www.nysenate.gov/legislation/bills/2025/S1104/amendment/A) took effect on June 17, capping a funder's take at 25 percent of a plaintiff's gross recovery and demanding plain-language contracts. The largest state in the funding market chose to regulate and cap. North Carolina chose to abolish. Two states, two weeks, two opposite theories of how to handle the same industry. At the federal level, a Grassley-led [transparency bill](https://www.govinfo.gov/app/details/BILLS-119s3826is) introduced in February would force disclosure in large class actions and multidistrict litigation, but even that reaches only for sunlight, not for the throat." },
      { type: "pullquote", text: "Two states, two weeks, two opposite theories of how to handle the same industry. New York chose to cap. North Carolina chose to abolish." },
      { type: "paragraph", text: "For litigators, the strategic stakes turn on what happens to the cases already funded. A plaintiff whose contingency lawyer is leaning on a funder's capital to outlast a deep-pocketed defendant loses that staying power if the arrangement becomes unenforceable inside the state. Defense counsel who have spent years arguing that funding fuels meritless, over-leveraged litigation get the most direct vindication imaginable, not a disclosure obligation but the removal of the fuel. Whether existing contracts survive, whether they get unwound, whether funders can restructure around the carve-outs, all of it rides on language Stein has not yet signed." },
      { type: "paragraph", text: "Which is exactly where the suspense sits. Stein is a Democrat, a former attorney general, and the trial bar that lives on funded cases is not a constituency a Democratic governor crosses lightly. A 45-to-1 Senate vote is veto-proof on its face, which narrows his real options to signing, letting it become law without his signature, or staging a veto fight he would likely lose. He has done none of those things yet. Every day the bill sits unsigned, the funding industry holds its breath and the rest of the country watches to see whether the first domino actually falls." },
      { type: "paragraph", text: "One signature. It has not happened. It is about to." },
    ],
  },
  {
    slug: "dryden-mutual-disclaim-forfeit",
    section: "Litigation Strategy",
    tag: "Bad Faith",
    title: "A Carrier Disclaimed Without Suing. A Court Made It Pay $2.84M",
    subtitle:
    ...
    readers: 1908,
    content: [
      { type: "paragraph", text: "The number was $2,841,782, and Dryden Mutual Insurance Company never argued against a dollar of it. On June 5, the [Appellate Division, Fourth Department](https://www.insurancebusinessmag.com/us/news/risk-compliance-legal/court-says-insurer-refusing-defense-loses-badfaith-and-damages-fight-578108.aspx) in New York told the carrier why. It had chosen to walk away from a defense without ever asking a court whether it could. That choice cost it the right to be heard on the damages at all." },
      { type: "paragraph", text: "The underlying fight started with an injured worker and a contractor named Cory Lisinski, who did business as CNL Construction and Maintenance. When the claim landed on Dryden Mutual's desk, the carrier read its policy, found a workers'-compensation exclusion, and disclaimed. It sent its letter, declined to defend, and treated the matter as closed." },
      { type: "paragraph", text: "What Dryden Mutual did not do is the move that mattered. It never filed a [declaratory-judgment action](https://www.insurancebusinessmag.com/us/news/risk-compliance-legal/court-says-insurer-refusing-defense-loses-badfaith-and-damages-fight-578108.aspx) to test the disclaimer before a judge. It assumed the exclusion was good and acted as if the question were settled. It was not settled. It was only unasked." },
      { type: "paragraph", text: "With no defense behind him, Lisinski was exposed. A default judgment followed, and the number attached to it was $2,841,782. The judgment then traveled, as these judgments do, through an assignment to Louis Shattuck, who stepped into the claimant's shoes and came for the carrier that had refused to show up." },
      { type: "paragraph", text: "By the time Dryden Mutual wanted to contest the size of the award, the court had a one-word answer. No. An insurer that disclaims and refuses to defend without first seeking a declaratory judgment, the [Fourth Department](https://www.insurancebusinessmag.com/us/news/risk-compliance-legal/court-says-insurer-refusing-defense-loses-badfaith-and-damages-fight-578108.aspx) held, forfeits the right to contest both liability and damages. The carrier had spent its objections before it ever made them." },
      { type: "paragraph", text: "The doctrine here is older than the case, and that is what makes the result so unforgiving. New York has long required an insurer that wants out of a defense to litigate its way out. The clean path is the declaratory-judgment action, where the carrier puts the exclusion in front of a judge and asks whether the duty to defend applies. Skip that step, gamble on being right, and the coverage question collapses into a single narrow inquiry. A carrier in Dryden Mutual's position is left to argue only one thing, whether the [disclaimer itself was valid](https://www.insurancebusinessmag.com/us/news/risk-compliance-legal/court-says-insurer-refusing-defense-loses-badfaith-and-damages-fight-578108.aspx). Everything downstream of that, the liability finding and the dollar figure, is closed." },
      { type: "paragraph", text: "Read that against what Dryden Mutual was hoping for. The playbook it ran is a familiar one. Disclaim now, save the defense cost, and if a judgment lands later, fight the number then. The damages, the theory goes, can always be argued down on the back end. The Fourth Department took that back end away. There is no later fight. There is only the disclaimer, and if the disclaimer fails, the carrier owns the judgment whole." },
      { type: "pullquote", text: "There is no later fight. There is only the disclaimer, and if the disclaimer fails, the carrier owns the judgment whole." },
      { type: "paragraph", text: "The exclusion may even have been a strong one. A workers'-compensation carve-out is the kind of provision carriers win on regularly. But the court's ruling does not turn on whether Dryden Mutual was right about coverage. It turns on the order of operations. A carrier that is confident in its exclusion has every reason to prove it in a declaratory action, where being right ends the case. A carrier that disclaims unilaterally is betting that no one will ever make it answer. When someone does, the strength of the exclusion is the only card left, and it has to carry the entire $2.84 million." },
      { type: "paragraph", text: "The bad-faith piece sharpens the edge. The court did not stop at the forfeiture. It also let claims of bad faith survive, the kind built on a gross disregard of the insured's interests. That keeps the door open to exposure beyond the policy limit, the extracontractual territory where a number stops being capped by the contract. A carrier that walks away cleanly and quietly can find that the walk itself becomes the evidence." },
      { type: "paragraph", text: "What lands hardest is how avoidable the whole thing was. Dryden Mutual did not lose because its lawyers misread a clause or missed a deadline. It lost because it treated a contestable coverage position as a decided one and never gave a court the chance to agree. The declaratory-judgment action is not an afterthought in New York. It is the price of contesting coverage at all, and the carrier declined to pay it." },
      { type: "paragraph", text: "The assignee walked away with a judgment the carrier never tested. Shattuck holds a number that Dryden Mutual cannot touch, built on a default the carrier created by staying home. In New York, the carrier that refuses to fight in the right forum does not get to fight in any forum. It only gets the bill." },
    ],
  },
  {
    slug: "dali-key-bridge-economic-loss",
    section: "Litigation Strategy",
    tag: "Supply Chain",
    title: "The Dali's Owner Wants a 1927 Rule to Erase $40M in Key Bridge Claims",
    subtitle:
  ...
  },
  {
    ...
    readers: 1759,
    content: [
      { type: "paragraph", text: "On June 15, in the [Eastern District of New York](https://www.courtlistener.com/docket/72191529/greater-new-york-mutual-insurance-company-v-liakas-law-pc/), Liakas Law turned the gun around. The firm did not stand in front of the judge to defend a personal-injury client. It stood there as a defendant, and it asked the court to punish the company suing it. The company is [Greater New York Mutual](https://www.theinsurer.com/ti/news/greater-new-york-mutual-insurance-files-two-rico-lawsuits-against-law-firms-2026-01-30/), an insurer. The weapon GNY brought was a 207-page federal racketeering complaint. Liakas called the carrier's filings a \"copy-paste\" abuse of the court." },
      { type: "paragraph", text: "That sentence is the whole story, and it has nothing to do with New York no-fault arcana. A carrier sued a law firm under RICO. The law firm counter-attacked in open court. It is the first time a named plaintiff firm has stood up and tried to sanction a carrier's offensive RICO playbook to its face. Every general counsel watching the defense-to-offense shift in litigation should watch what happens next." },
