...
export const FEATURED_ARTICLE: NewsletterArticle = {
  ...
  tag: "Case Watch",
  title: "He Couldn't Dress Himself. In Brooklyn, Greater NY Mutual Filed the Soccer Photo.",
  subtitle:
    "An insurer became the plaintiff and pointed federal RICO — the racketeering statute built for the mob — at a plaintiffs' firm, with a soccer-tournament photo of a man who swore he couldn't dress himself as Exhibit A.",
  readTime: "5 min read",
  author: "Wesley Todd",
  date: "June 5, 2026",
  readers: 2213,
  trending: true,
  content: [
    { type: "paragraph", text: "The man swore under his injury claim that he could not dress himself without help. On January 27, 2026, Greater New York Mutual Insurance Company dropped into a 207-page federal complaint in Brooklyn the photo it had found: the same man, weeks earlier, in full uniform with his soccer team, beneath a caption that read \"celebrating a soccer tournament we won.\" The picture, the complaint says, shows eleven people responsible for twelve injury lawsuits standing in a single frame." },
    ...
    { type: "paragraph", text: "The defendants are the firm, Liakas Law, P.C., and two of its principals, Dean N. Liakas and Nicholas E. Liakas. Special counsel Ali Najmi is named. So is a litigation funder, Jumpstart Funding LLC. The cause of action is civil RICO. That is the federal racketeering statute built for the mob. Greater New York Mutual is pointing it at a law firm." },
    ...
    { type: "paragraph", text: "The recruitment is where it turns ugly. The complaint alleges that runners found vulnerable people. Often undocumented. Often immigrants with no good reason to trust the courts and every reason to take the cash. The runners steered them into staged or exaggerated trip-and-fall accidents at sites across New York State. Then the claimants were routed through medical procedures they did not need. The records were dressed up. The demand letters went out inflated." },
    { type: "paragraph", text: "The soccer player is one face of that. The complaint reportedly carries other exhibits in the same key. A woman whose injury claim sits next to social-media posts of her bowling and dancing. The point of each is the same. The body in the medical file does not match the body in the photo. The carrier is asking a federal judge to read the gap as fraud." },
    { type: "paragraph", text: "There is a real defense, and it is sharp. Liakas Law sent a spokesman, Hank Sheinkopf, who did not flinch. \"Big insurance files a baseless claim, seeks to vilify plaintiff lawyers, and watches the case fall apart once judicial scrutiny is applied,\" he said. \"Judges have consistently rejected these attempts because they are unsupported by facts or law.\" That is not noise. Greater New York Mutual filed two of these RICO suits at once, and a sibling case against a different firm was reported dismissed last year. The carrier has swung this bat before and missed. The firm knows it." },
    ...
    { type: "pullquote", text: "Greater New York Mutual gave the whole thing a name. It called it a \"fraudemic.\" A campaign, not an accident." },
    { type: "paragraph", text: "The word is doing work. It frames a single firm as a node in something the carrier says is everywhere, and it tells you the insurer plans to keep filing." },
    { type: "paragraph", text: "What happens next runs through the docket. Watch the [Eastern District of New York](https://www.courtlistener.com/docket/72191529/greater-new-york-mutual-insurance-company-v-liakas-law-pc/) for a motion to dismiss. The sibling case fell there. This one may too, or it may not. The complaint is built on photos a jury can see with its own eyes. A man who could not dress himself, in a team jersey, holding a trophy. The carrier is betting that picture is worth more than a brief." },
...
export const ARTICLES: NewsletterArticle[] = [
  {
    ...
    tag: "Case Watch",
    title: "He Couldn't Dress Himself. In Brooklyn, Greater NY Mutual Filed the Soccer Photo.",
    subtitle: "An insurer became the plaintiff and pointed federal RICO — the racketeering statute built for the mob — at a plaintiffs' firm, with a soccer-tournament photo of a man who swore he couldn't dress himself as Exhibit A.",
    readTime: "5 min read",
    author: "Wesley Todd",
    date: "June 5, 2026",
    readers: 2213,
  ...
  },
  {
    ...
    tag: "Case Watch",
    title: "Two Cases That Never Existed. Mike Sethi Is Off the Ninth Circuit Six Months.",
    ...
    content: [
      ...
      { type: "paragraph", text: "The lawyer who filed them was Mike Singh Sethi of the Sethi Law Group in Orange, California. The brief was an immigration appeal, Lnu v. Blanche, No. 24-4790. Sethi argued it. William Rounds, of Bill Rounds Attorney at Law PC, also in Orange, was on the briefs. Judges Richard Paez, Carlos Bea, and Danielle Forrest sat on the panel. They did not buy what came next." },
      ...
      { type: "paragraph", text: "For half a year, in the largest federal circuit in the country, Mike Sethi cannot file. He typed two cases that were never real. Now he is out." },
    ],
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "In late August 2022 Sysco negotiated a deal. It would [resolve the Broilers case against Pilgrim's Pride for $50 million](https://www.courthousenews.com/seventh-circuit-chickens-out-of-50-million-poultry-settlement-brokered-over-email/). Sysco told Burford. Burford thought the number was too low and withheld its consent. Then it went further. Burford filed a Request for Arbitration to block Sysco from settling, and it won a temporary restraining order to stop the company from executing the very deal it had struck. The party that had been wronged in the chicken market wanted out. The party that had written the checks would not let it leave." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "The sponsor framed the stakes in the language of protection. Senator Jeremy Cooney, who carried the bill that became Chapter 645 of 2025, called the signing [a historic step forward in protecting everyday New Yorkers from opaque and often predatory litigation financing practices](https://www.insurancejournal.com/news/east/2026/01/07/853304.htm). Translated into the funder's ledger, the protection is a 25% revenue ceiling and a principal-forfeiture trigger on the country's second-largest litigation market." },
    ],
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Read the compensatory math and the shape of the thing comes into focus. Of the roughly $42.6 million in compensatory damages, [$19.5 million went to the Benavides estate and $23.1 million to Angulo](https://www.insurancejournal.com/news/national/2026/02/23/859068.htm). Tesla pays its third of that, plus the entire $200 million punitive load that no apportionment touches. The driver dropped the phone. The company paid for the system that was steering when he did." },
      ...
      { type: "paragraph", text: "For anyone holding exposure on automated-driving systems, the story does not end in the courtroom. It moves to the reserve. A claim like this does not behave like an ordinary auto file. It carries punitive damages that ride the manufacturer regardless of how the driver's fault gets carved up. It carries a punitive multiple, here, $200 million against $42.6 million in actual harm, that ordinary loss-development triangles never anticipated. It survived a remittitur motion, which means a court has already declined to call it excessive. The driver's share of fault did not cap the company's share of the punitive bill. Nothing did." },
