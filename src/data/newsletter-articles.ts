...
export const ARTICLES: NewsletterArticle[] = [
  ...
  },
  {
    ...
    sources: [
      ...
      {
        claim: "Independent reporting of the $23.1M Aroostook County verdict and Northern Light Health's statement disagreeing with the verdict and the magnitude of the award",
        locator: "Bangor Daily News, 'Jury awards $23M to paralyzed Madawaska man'",
        url: "https://www.bangordailynews.com/2026/06/18/aroostook/aroostook-police-courts/jury-awards-23m-to-paralyzed-madawaska-man-northern-light-health/",
      },
    ],
  },
  {
    ...
    subtitle: "A small splash of molten aluminum started a fire that ran past $100 million. ACE American read one endorsement to cap the molten-metal exposure at $10 million. A jury awarded JW Aluminum $112.3 million, the full $80 million sub-limit included. Now the insurers have appealed to the Fourth Circuit.",
    readTime: "5 min read",
    author: "Wesley Todd",
    date: "June 26, 2026",
    trending: false,
    content: [
      { type: "paragraph", text: "In 2020, on a production line in Goose Creek, South Carolina, a small splash of molten aluminum hit the floor and started a fire that nearly took the whole plant. No worker was hurt. No first responder was hurt. The damage ran past a hundred million dollars anyway, tens of millions in wrecked equipment and hundreds of millions in lost profits, all from a splash that small." },
